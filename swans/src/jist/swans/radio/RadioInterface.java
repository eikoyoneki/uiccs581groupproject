 ...
 * @version $Id: RadioInterface.java,v 1.1 2007/04/09 18:49:47 drchoffnes Exp $
 * @since SWANS1.0
 */
...
public interface RadioInterface extends JistAPI.Proxiable
{
   ...
   *
   * @param power signal strength of incoming message (units: mW)
   * @param seqNumber the sequence number corresponding to the packet here
   */
  void endReceive(Double power, Long seqNumber);
...
/**
 * Records amount of time observing signals.
 * 
 * @param congestionInterval the interval to perform the calculation
 */
void recordActivity(long congestionInterval);
