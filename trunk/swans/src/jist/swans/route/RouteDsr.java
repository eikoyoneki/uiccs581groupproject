 ...
 * @version $Id: RouteDsr.java,v 1.1 2007/04/09 18:49:30 drchoffnes Exp $
 * @since SWANS1.0
 */
    ...
    if (msg instanceof NetMessage.Ip)
    {
      ...
      if (ipMsg.getProtocol() == Constants.NET_PROTOCOL_DSR)
      {
        ...
        ProcessOptions(dsrMsg, ipMsg.getSrc(), ipMsg.getDst(),
          ipMsg.getProtocol(), ipMsg.getPriority(), (byte)ipMsg.getTTL(),
...
public int getProtocolId() throws Continuation {
	return Constants.NET_PROTOCOL_DSR;
}
